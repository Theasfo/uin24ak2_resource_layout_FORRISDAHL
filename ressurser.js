...
function renderlist(categoryName){
    ...
    document.getElementById("Tittleteks").innerHTML = categoryText
    document.getElementById("Tittelvis").innerHTML = categoryTitle
    document.getElementById("Listevis").innerHTML = listHTML
}